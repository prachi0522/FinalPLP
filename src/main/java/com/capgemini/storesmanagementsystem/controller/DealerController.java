...
public class DealerController {
	...
	void dealerTask() {
		...
		do {
			log.info("******Welcome to the Dealer's page*********");
			...
			case 2:
				log.info("Enter the order Id you want to delete");
				int n = scan.nextInt();
				dao.deleteOrder(n);
				log.info("Order Id is deleted Succesfully");
				break;
			...
			case 4:
				...
				log.info("Enter the User Id to see Store Information");
				...
				break;
			case 5:
				log.info("Enter the Store Id you want to See....");
